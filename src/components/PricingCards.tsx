...
export default function PricingCards() {
  ...
  const ecosystemApps = ecosystemAppDefs.map((app) => ({
    ...app,
    comingSoon: isAppInactive(platformApps, app.appKey),
  }));
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        {/* Ecosystem Monthly */}
        <div
          className="rounded-2xl border-2 border-primary/40 bg-card relative flex flex-col justify-between md:scale-[1.03]"
          style={{
        ...
        >
          ...
          <div className="p-7 space-y-5">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Acesso completo a todos os aplicativos da UNITRIX.
            </p>
